...
import com.drogueria.dto.ProviderTypeDTO;
...
public class ProviderTypeAdministrationController {
	...
	public ModelAndView providerTypes() {
	...
	public @ResponseBody ProviderType saveProviderType(@RequestBody ProviderTypeDTO providerTypeDTO) throws Exception {
