...
insert into `institute_dev`.`role` values (1, 'INPUT', 'Ingreso');
insert into `institute_dev`.`role` values (2, 'OUTPUT', 'Egreso');
insert into `institute_dev`.`role` values (3, 'PROVISIONING_REQUEST', 'Pedido');
insert into `institute_dev`.`role` values (4, 'PROVISIONING_REQUEST_UPDATE', 'Modificación de Pedido');
insert into `institute_dev`.`role` values (5, 'PROVISIONING_REQUEST_AUTHORIZATION', 'Autorización de Pedidos');
insert into `institute_dev`.`role` values (6, 'PROVISIONING_REQUEST_CANCELLATION', 'Anulación de Pedidos');
insert into `institute_dev`.`role` values (7, 'PROVISIONING_REQUEST_PRINT', 'Impresión de Hojas de Picking');
insert into `institute_dev`.`role` values (8, 'ORDER_ASSEMBLY', 'Armado de Pedido');
insert into `institute_dev`.`role` values (9, 'ORDER_ASSEMBLY_CANCELLATION', 'Anulación de Armado de Pedido');
insert into `institute_dev`.`role` values (10, 'DELIVERY_NOTE_PRINT', 'Emitir Remito');
insert into `institute_dev`.`role` values (11, 'DELIVERY_NOTE_CANCELLATION', 'Anulación de Remitos');
insert into `institute_dev`.`role` values (12, 'ENTITY_ADMINISTRATION', 'Administración de Entidades');
insert into `institute_dev`.`role` values (13, 'USER_ADMINISTRATION', 'Administración de Usuarios');
insert into `institute_dev`.`role` values (15, 'INPUT_CANCELLATION', 'Anulación de Ingreso');
insert into `institute_dev`.`role` values (16, 'INPUT_AUTHORIZATION', 'Autorización de Ingreso');
insert into `institute_dev`.`role` values (17, 'OUTPUT_CANCELLATION', 'Anulación de Egreso');
insert into `institute_dev`.`role` values (18, 'AGREEMENT_TRANSFER', 'Transferencia de Convenio');
insert into `institute_dev`.`role` values (19, 'SUPPLYING', 'Dispensa');
insert into `institute_dev`.`role` values (20, 'SUPPLYING_CANCELLATION', 'Anulación de Dispensa');
insert into `institute_dev`.`role` values (21, 'PENDING_TRANSACTIONS', 'Transacciones Pendientes');
insert into `institute_dev`.`role` values (22, 'LOGISTIC_OPERATOR_ASSIGNMENT', 'Asignacion de Operador Logistico');
insert into `institute_dev`.`role` values (23, 'SEARCH_INPUTS', 'Busqueda de Ingresos');
insert into `institute_dev`.`role` values (24, 'SEARCH_OUTPUTS', 'Busqueda de Ingresos');
insert into `institute_dev`.`role` values (25, 'SEARCH_PROVISIONING_REQUEST', 'Busqueda de Pedidos');
insert into `institute_dev`.`role` values (26, 'SEARCH_SUPPLYING', 'Busqueda de Dispensas');
insert into `institute_dev`.`role` values (27, 'SEARCH_DELIVERY_NOTE', 'Busqueda de Remitos');
insert into `institute_dev`.`role` values (28, 'SEARCH_AUDIT', 'Auditoria');
insert into `institute_dev`.`role` values (29, 'SEARCH_STOCK', 'Busqueda de Stock');
insert into `institute_dev`.`role` values (30, 'SEARCH_SERIALIZED_PRODUCT', 'Traza por Serie');
insert into `institute_dev`.`role` values (31, 'SEARCH_BATCH_EXPIRATEDATE_PRODUCT', 'Traza por Lote');
insert into `institute_dev`.`role` values (32, 'AFFILIATE_ADMINISTRATION', 'Administracion de Afiliados');
insert into `institute_dev`.`role` values (33, 'AGENT_ADMINISTRATION', 'Administracion de Agentes');
insert into `institute_dev`.`role` values (34, 'CLIENT_ADMINISTRATION', 'Administracion de Clientes');
insert into `institute_dev`.`role` values (35, 'CONCEPT_ADMINISTRATION', 'Administracion de Conceptos');
insert into `institute_dev`.`role` values (36, 'AGREEMENT_ADMINISTRATION', 'Administracion de Convenios');
insert into `institute_dev`.`role` values (37, 'EVENT_ADMINISTRATION', 'Administracion de Eventos');
insert into `institute_dev`.`role` values (38, 'DELIVERY_LOCATION_ADMINISTRATION', 'Administracion de Lugares de Entrega');
insert into `institute_dev`.`role` values (39, 'LOGISTIC_OPERATOR_ADMINISTRATION', 'Administracion de Operador Logistico');
insert into `institute_dev`.`role` values (40, 'PRODUCT_ADMINISTRATION', 'Administracion de Productos');
insert into `institute_dev`.`role` values (41, 'PROVIDER_ADMINISTRATION', 'Administracion de Proveedores');
insert into `institute_dev`.`role` values (42, 'DELIVERY_NOTE_ENUMERATOR_ADMINISTRATION', 'Administracion de Puntos de Venta');
...
insert into `institute_dev`.`user` values (1, "admin", "fad198c1bfe1cc7052905de0fa0431b45ec10ca4", 1,1);
