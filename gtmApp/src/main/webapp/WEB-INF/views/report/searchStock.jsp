...
<form id="searchStockForm" action="" onsubmit="return false;">
	...
	<div class="row">
		...
		<div class="col-md-3 col-lg-3 form-group">
			<label for="groupSearch"><spring:message code="common.productGroup"/></label>
			<select id="groupSearch" name="groupSearch" class="form-control chosen-select" data-placeholder="<spring:message code='common.select.option'/>">
				<option value=""></option>
				<c:forEach items="${groups}" var="group">
					<option value="${group.id}"><c:out value="${group.code}"></c:out> - <c:out value="${group.description}"></c:out></option>
				</c:forEach>
			</select>
		</div>
