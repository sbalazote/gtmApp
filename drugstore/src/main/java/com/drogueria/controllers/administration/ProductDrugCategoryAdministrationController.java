...
import com.drogueria.dto.ProductDrugCategoryDTO;
...
public class ProductDrugCategoryAdministrationController {
	...
	public @ResponseBody ProductDrugCategory saveProductBrand(@RequestBody ProductDrugCategoryDTO productDrugCategoryDTO) throws Exception {
