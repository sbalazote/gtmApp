...
public class ProductMonodrugsPdfView extends AbstractPdfView {
	...
	protected void buildPdfDocument(Map<String, Object> model, Document document, PdfWriter writer, HttpServletRequest req, HttpServletResponse resp)
		...
		for (ProductMonodrug productMonodrug : productMonodrugs) {
			...
			Chunk id = new Chunk(productMonodrug.getId().toString(), fontTitle);
			document.add(id);
			...
			Chunk code = new Chunk(productMonodrug.getCode().toString(), fontTitle);
			document.add(code);
			document.add(new Chunk(" "));
			...
			Chunk description = new Chunk(productMonodrug.getDescription(), fontTitle);
			...
			Chunk active = new Chunk(productMonodrug.isActive() ? "SI" : "NO", fontTitle);
			document.add(active);
			document.add(new Chunk(" "));
