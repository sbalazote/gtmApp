...
SelfSerialized = function() {
	...
	$("#outOfStockSelfSerializedGenerateButton").click(function() {
		...
		if (remainingAmount > 0) {
			...
			myShowAlert('danger', 'Ya se ha ingresado la totalidad de productos requeridos. Por favor presione el bot&oacute;n "Confirmar".', "outOfStockSelfSerializedModalAlertDiv");
		}
	});
