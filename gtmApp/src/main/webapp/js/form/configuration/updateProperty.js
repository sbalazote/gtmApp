    ...
    var validateForm = function () {
        ...
        form.validate({
            rules: {
                ...
                logisticsOperatorX: {required: true, digits: true},
                logisticsOperatorY: {required: true, digits: true}
            },
    ...
    $("#confirm").click(function () {
        if (validateForm()) {
            var jsonProperties = {
                ...
                "logisticsOperatorX": $("#logisticsOperatorXInput").val(),
                "logisticsOperatorY": $("#logisticsOperatorYInput").val(),
                "logisticsOperatorPrint": $("#logisticsOperatorPrintInput").is(":checked")
            };
