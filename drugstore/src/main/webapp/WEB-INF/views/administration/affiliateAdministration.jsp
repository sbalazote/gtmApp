				...
				<div class="row">
					<div class="col-md-4 form-group">
						...
						<select class="form-control chosen-select" id="documentTypeSelect" name="documentType">
							<option value="DNI"><spring:message code="administration.documentType.DNI"/></option>
							<option value="LE"><spring:message code="administration.documentType.LE"/></option>
							<option value="LC"><spring:message code="administration.documentType.LC"/></option>
						</select>
					</div>
					<div class="col-md-4 form-group">
