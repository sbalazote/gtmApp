...
insert into logistics_operator (id, code, name, tax_id, corporate_name, gln, province_id, locality, address, zip_code, phone, active) 
values (2, 8687,'OCA 2','30-99991112-0','OCA2. SA', 11112,1,'Capital Federal','Rivadavia 7700','1507','4639-8888', true);
...
INSERT INTO `property` (id, code, name, tax_id, corporate_name, province_id, locality, address, zip_code, phone, mail, gln, agent_id, last_tag, self_serialized_tag_filepath, ANMAT_password, start_trace_concept_id, proxy,proxy_port,inform_proxy,supplying_concept_id, provisioning_require_authorization, print_picking_list, inform_anmat, VAT_liability_id)
VALUES (1,86,'FARMACIA','30686437228','FARMACIA',1,'C.A.B.A.','AGUERO 1223','1425','4963-1500',NULL,'7798169170001',7,0,'C:/selfSerializedTagsPrinter/',"ZrFFnPSO9FCCOwRq7/DYzg==",23,"","",0,1,0,0,0,1);
...
insert into `pharmacy_dev`.`role` values (12, 'USER_ADMINISTRATION', 'Administración de Usuarios');
insert into `pharmacy_dev`.`role` values (13, 'SERIALIZED_RETURNS', 'Devolución de Series');
insert into `pharmacy_dev`.`role` values (14, 'INPUT_CANCELLATION', 'Anulación de Ingreso');
insert into `pharmacy_dev`.`role` values (15, 'INPUT_AUTHORIZATION', 'Autorización de Ingreso');
insert into `pharmacy_dev`.`role` values (16, 'PRODUCT_DESTRUCTION', 'Destrucción de Mercadería');
insert into `pharmacy_dev`.`role` values (17, 'AGREEMENT_TRANSFER', 'Transferencia de Convenio');
insert into `pharmacy_dev`.`role` values (18, 'SUPPLYING', 'Dispensa');
insert into `pharmacy_dev`.`role` values (19, 'PENDING_TRANSACTIONS', 'Transacciones Pendientes');
insert into `pharmacy_dev`.`role` values (20, 'LOGISTIC_OPERATOR_ASSIGNMENT', 'Asignacion de Operador Logistico');
insert into `pharmacy_dev`.`role` values (21, 'SEARCH_INPUTS', 'Busqueda de Ingresos');
insert into `pharmacy_dev`.`role` values (22, 'SEARCH_OUTPUTS', 'Busqueda de Egresos');
insert into `pharmacy_dev`.`role` values (23, 'SEARCH_PROVISIONING_REQUEST', 'Busqueda de Pedidos');
insert into `pharmacy_dev`.`role` values (24, 'SEARCH_SUPPLYING', 'Busqueda de Dispensas');
insert into `pharmacy_dev`.`role` values (25, 'SEARCH_DELIVERY_NOTE', 'Busqueda de Remitos');
insert into `pharmacy_dev`.`role` values (26, 'SEARCH_AUDIT', 'Auditoria');
insert into `pharmacy_dev`.`role` values (27, 'SEARCH_STOCK', 'Busqueda de Stock');
insert into `pharmacy_dev`.`role` values (28, 'SEARCH_SERIALIZED_PRODUCT', 'Traza por Serie');
insert into `pharmacy_dev`.`role` values (29, 'SEARCH_BATCH_EXPIRATEDATE_PRODUCT', 'Traza por Lote');
insert into `pharmacy_dev`.`role` values (30, 'AFFILIATE_ADMINISTRATION', 'Administracion de Afiliados');
insert into `pharmacy_dev`.`role` values (31, 'AGENT_ADMINISTRATION', 'Administracion de Agentes');
insert into `pharmacy_dev`.`role` values (32, 'CLIENT_ADMINISTRATION', 'Administracion de Clientes');
insert into `pharmacy_dev`.`role` values (33, 'CONCEPT_ADMINISTRATION', 'Administracion de Conceptos');
insert into `pharmacy_dev`.`role` values (34, 'AGREEMENT_ADMINISTRATION', 'Administracion de Convenios');
insert into `pharmacy_dev`.`role` values (35, 'EVENT_ADMINISTRATION', 'Administracion de Eventos');
insert into `pharmacy_dev`.`role` values (36, 'DELIVERY_LOCATION_ADMINISTRATION', 'Administracion de Lugares de Entrega');
insert into `pharmacy_dev`.`role` values (37, 'LOGISTIC_OPERATOR_ADMINISTRATION', 'Administracion de Operador Logistico');
insert into `pharmacy_dev`.`role` values (38, 'PRODUCT_ADMINISTRATION', 'Administracion de Productos');
insert into `pharmacy_dev`.`role` values (39, 'PROVIDER_ADMINISTRATION', 'Administracion de Proveedores');
insert into `pharmacy_dev`.`role` values (40, 'DELIVERY_NOTE_ENUMERATOR_ADMINISTRATION', 'Administracion de Puntos de Venta');
insert into `pharmacy_dev`.`role` values (41, 'PROVIDER_SERIALIZED_FORMAT_ADMINISTRATION', 'Administracion de Formatos de Serializacion');
