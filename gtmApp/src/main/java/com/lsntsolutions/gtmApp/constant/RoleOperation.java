...
public enum RoleOperation {
	...
	PROVISIONING_REQUEST_UPDATE("Pedido", 4),
	PROVISIONING_REQUEST_AUTHORIZATION("Autorizacion de Pedido", 5),
	PROVISIONING_REQUEST_CANCELLATION("Anulación de Pedido", 6),
	...
	ORDER_LABEL_PRINT("Impresión de Rótulos", 46);
