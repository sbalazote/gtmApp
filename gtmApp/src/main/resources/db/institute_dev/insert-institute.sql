...
insert into `institute_dev`.`role` values (4, 'PROVISIONING_REQUEST_UPDATE', 'Modificación de Pedidos');
...
insert into `institute_dev`.`role` values (12, 'USER_ADMINISTRATION', 'Administración de Usuarios');
insert into `institute_dev`.`role` values (13, 'SERIALIZED_RETURNS', 'Devolución de Series');
insert into `institute_dev`.`role` values (14, 'INPUT_CANCELLATION', 'Anulación de Ingreso');
insert into `institute_dev`.`role` values (15, 'INPUT_AUTHORIZATION', 'Autorización de Ingreso');
insert into `institute_dev`.`role` values (16, 'PRODUCT_DESTRUCTION', 'Destrucción de Mercadería');
insert into `institute_dev`.`role` values (17, 'AGREEMENT_TRANSFER', 'Transferencia de Convenio');
insert into `institute_dev`.`role` values (18, 'SUPPLYING', 'Dispensa');
insert into `institute_dev`.`role` values (19, 'PENDING_TRANSACTIONS', 'Transacciones Pendientes');
insert into `institute_dev`.`role` values (20, 'LOGISTIC_OPERATOR_ASSIGNMENT', 'Asignacion de Operador Logistico');
insert into `institute_dev`.`role` values (21, 'SEARCH_INPUTS', 'Busqueda de Ingresos');
insert into `institute_dev`.`role` values (22, 'SEARCH_OUTPUTS', 'Busqueda de Egresos');
insert into `institute_dev`.`role` values (23, 'SEARCH_PROVISIONING_REQUEST', 'Busqueda de Pedidos');
insert into `institute_dev`.`role` values (24, 'SEARCH_SUPPLYING', 'Busqueda de Dispensas');
insert into `institute_dev`.`role` values (25, 'SEARCH_DELIVERY_NOTE', 'Busqueda de Remitos');
insert into `institute_dev`.`role` values (26, 'SEARCH_AUDIT', 'Auditoria');
insert into `institute_dev`.`role` values (27, 'SEARCH_STOCK', 'Busqueda de Stock');
insert into `institute_dev`.`role` values (28, 'SEARCH_SERIALIZED_PRODUCT', 'Traza por Serie');
insert into `institute_dev`.`role` values (29, 'SEARCH_BATCH_EXPIRATEDATE_PRODUCT', 'Traza por Lote');
insert into `institute_dev`.`role` values (30, 'AFFILIATE_ADMINISTRATION', 'Administracion de Afiliados');
insert into `institute_dev`.`role` values (31, 'AGENT_ADMINISTRATION', 'Administracion de Agentes');
insert into `institute_dev`.`role` values (32, 'CLIENT_ADMINISTRATION', 'Administracion de Clientes');
insert into `institute_dev`.`role` values (33, 'CONCEPT_ADMINISTRATION', 'Administracion de Conceptos');
insert into `institute_dev`.`role` values (34, 'AGREEMENT_ADMINISTRATION', 'Administracion de Convenios');
insert into `institute_dev`.`role` values (35, 'EVENT_ADMINISTRATION', 'Administracion de Eventos');
insert into `institute_dev`.`role` values (36, 'DELIVERY_LOCATION_ADMINISTRATION', 'Administracion de Lugares de Entrega');
insert into `institute_dev`.`role` values (37, 'LOGISTIC_OPERATOR_ADMINISTRATION', 'Administracion de Operador Logistico');
insert into `institute_dev`.`role` values (38, 'PRODUCT_ADMINISTRATION', 'Administracion de Productos');
insert into `institute_dev`.`role` values (39, 'PROVIDER_ADMINISTRATION', 'Administracion de Proveedores');
insert into `institute_dev`.`role` values (40, 'DELIVERY_NOTE_ENUMERATOR_ADMINISTRATION', 'Administracion de Puntos de Venta');
insert into `institute_dev`.`role` values (41, 'PROVIDER_SERIALIZED_FORMAT_ADMINISTRATION', 'Administracion de Formatos de Serializacion');
insert into `institute_dev`.`role` values (42, 'PROFILE_ADMINISTRATION', 'Administracion de Perfiles');
insert into `institute_dev`.`role` values (43, 'PROPERTY_ADMINISTRATION', 'Administracion de Propiedades');
insert into `institute_dev`.`role` values (44, 'ORDER_LABEL_PRINT', 'Impresion de Rotulos');
insert into `institute_dev`.`role` values (45, 'FAKE_DELIVERY_NOTE_PRINT', 'Impresión de Remito Propio');
insert into `institute_dev`.`role` values (46, 'FORCED_INPUT', 'Ingreso Forzado');
insert into `institute_dev`.`role` values (47, 'FORCED_INPUT_UPDATE', 'Modificación de Ingreso Forzado');
