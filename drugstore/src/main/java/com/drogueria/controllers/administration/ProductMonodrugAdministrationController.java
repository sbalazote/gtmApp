...
import com.drogueria.dto.ProductMonodrugDTO;
...
public class ProductMonodrugAdministrationController {
	...
	public ModelAndView productMonodrugs() {
	...
	public @ResponseBody ProductMonodrug saveProductMonodrug(@RequestBody ProductMonodrugDTO productMonodrugDTO) throws Exception {
