...
public class CatalogoGTINResult  extends com.inssjp.mywebservice.business.ResultadoPersonalizado  implements java.io.Serializable {
    private com.inssjp.mywebservice.business.MedicamentoPlain[] list;
    ...
    public CatalogoGTINResult() {
    }

    public CatalogoGTINResult(
           java.lang.Long _id_generado,
           java.lang.Boolean _is_modificado,
           com.inssjp.mywebservice.business.MedicamentoPlain[] list,
    ...
    /**
     * Gets the list value for this CatalogoGTINResult.
     * 
     * @return list
     */
    public com.inssjp.mywebservice.business.MedicamentoPlain[] getList() {
        return list;
    }


    /**
     * Sets the list value for this CatalogoGTINResult.
     * 
     * @param list
     */
    public void setList(com.inssjp.mywebservice.business.MedicamentoPlain[] list) {
        this.list = list;
    }

    public com.inssjp.mywebservice.business.MedicamentoPlain getList(int i) {
        return this.list[i];
    }

    public void setList(int i, com.inssjp.mywebservice.business.MedicamentoPlain _value) {
        this.list[i] = _value;
    }


    /**
     * Gets the cantPaginas value for this CatalogoGTINResult.
     * 
     * @return cantPaginas
     */
    ...
    /**
     * Sets the cantPaginas value for this CatalogoGTINResult.
     * 
     * @param cantPaginas
     */
    ...
    /**
     * Gets the hay_error value for this CatalogoGTINResult.
     * 
     * @return hay_error
     */
    ...
    /**
     * Sets the hay_error value for this CatalogoGTINResult.
     * 
     * @param hay_error
     */
    ...
    /**
     * Gets the errores value for this CatalogoGTINResult.
     * 
     * @return errores
     */
    ...
    /**
     * Sets the errores value for this CatalogoGTINResult.
     * 
     * @param errores
     */
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof CatalogoGTINResult)) return false;
        CatalogoGTINResult other = (CatalogoGTINResult) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(CatalogoGTINResult.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://business.mywebservice.inssjp.com/", "catalogoGTINResult"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("list");
        elemField.setXmlName(new javax.xml.namespace.QName("", "list"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://business.mywebservice.inssjp.com/", "medicamentoPlain"));
