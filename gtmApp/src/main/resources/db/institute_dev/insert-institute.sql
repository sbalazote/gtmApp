...
insert into `institute_dev`.`role` values (3, 'PROVISIONING_REQUEST', 'Solicitud de Abastecimiento');
insert into `institute_dev`.`role` values (4, 'PROVISIONING_REQUEST_UPDATE', 'Modificación de Solicitudes');
insert into `institute_dev`.`role` values (5, 'PROVISIONING_REQUEST_AUTHORIZATION', 'Autorización de Solicitudes');
insert into `institute_dev`.`role` values (6, 'PROVISIONING_REQUEST_CANCELLATION', 'Anulación de Solicitudes');
