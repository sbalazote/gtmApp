...
public class SerializedProductsPdfView extends AbstractPdfView {
    ...
    protected void buildPdfDocument(Map<String, Object> model, Document document, PdfWriter writer, HttpServletRequest req, HttpServletResponse resp)
        ...
        com.lowagie.text.Image logo = com.lowagie.text.Image.getInstance(absoluteDiskPath);
        ...
        for (Output output : outputs) {
            ...
            productCodeHeader.setBorder(com.lowagie.text.Rectangle.BOTTOM | com.lowagie.text.Rectangle.TOP);
            productCodeHeader.setBorder(com.lowagie.text.Rectangle.BOTTOM | com.lowagie.text.Rectangle.TOP);
            productDescriptionHeader.setBorder(com.lowagie.text.Rectangle.BOTTOM | com.lowagie.text.Rectangle.TOP);
            productBatchHeader.setBorder(com.lowagie.text.Rectangle.BOTTOM | com.lowagie.text.Rectangle.TOP);
            productExpirationDateHeader.setBorder(com.lowagie.text.Rectangle.BOTTOM | com.lowagie.text.Rectangle.TOP);
            productSerialNumberHeader.setBorder(com.lowagie.text.Rectangle.BOTTOM | com.lowagie.text.Rectangle.TOP);
            productAmountHeader.setBorder(com.lowagie.text.Rectangle.BOTTOM | com.lowagie.text.Rectangle.TOP);
            ...
            for(Integer productId : groupByProduct.keySet()){
                ...
                if(groupByProduct.get(productId).size() > 1) {
                    ...
                    productCodeDetail.setBorder(com.lowagie.text.Rectangle.NO_BORDER);
                    productDescriptionDetail.setBorder(com.lowagie.text.Rectangle.NO_BORDER);
                    productBatchDetail.setBorder(com.lowagie.text.Rectangle.NO_BORDER);
                    productExpirationDateDetail.setBorder(com.lowagie.text.Rectangle.NO_BORDER);
                    productSerialNumberDetail.setBorder(com.lowagie.text.Rectangle.NO_BORDER);
                    productAmountDetail.setBorder(com.lowagie.text.Rectangle.NO_BORDER);
