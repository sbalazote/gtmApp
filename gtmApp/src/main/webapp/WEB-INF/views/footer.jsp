...
<div class="container">
	<div class="text-center center-block">
		...
		<a target="_blank" href="mailto:info@LSTSolutions.com"><i id="socialMail" class="fa fa-envelope-square fa-3x social-em"></i></a> <br />
		<p class="text-footer">Copyright@ LS&amp;T Solutions 2015-2016. Todos los derechos reservados.</p>
	</div>
</div>