...
import com.drogueria.dto.LogisticsOperatorDTO;
...
public class LogisticsOperatorAdministrationController {
	...
	public @ResponseBody LogisticsOperator saveLogisticsOperator(@RequestBody LogisticsOperatorDTO logisticsOperatorDTO) throws Exception {
