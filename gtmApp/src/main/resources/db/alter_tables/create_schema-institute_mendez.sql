...
DROP SCHEMA IF EXISTS `institute_mendez_mendez`;

/*La primera vez hay que comentar esto */
/*DROP USER gtm;*/

CREATE DATABASE institute_mendez;
/*CREATE USER gtm IDENTIFIED BY 'Gtm4pPlsNt';*/
GRANT ALL PRIVILEGES ON `institute_mendez`.* TO `gtm`@`localhost` IDENTIFIED BY 'Gtm4pPlsNt';

USE institute_mendez;

CREATE TABLE `institute_mendez`.`agent` (
...
CREATE TABLE `institute_mendez`.`event` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `code` int(11) NOT NULL,
...
CREATE TABLE `institute_mendez`.`product_group` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `code` int(11) NOT NULL,
...
CREATE TABLE `institute_mendez`.`product_drug_category` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `code` int(11) NOT NULL,
  `description` varchar(45) NOT NULL,
  `active` bit(1) NOT NULL,
...
CREATE TABLE `institute_mendez`.`product_brand` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `code` int(11) NOT NULL,
  `description` varchar(45) NOT NULL,
  `active` bit(1) NOT NULL,
...
CREATE TABLE `institute_mendez`.`product_monodrug` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `code` int(11) NOT NULL,
  `description` varchar(45) NOT NULL,
  `active` bit(1) NOT NULL,
...
CREATE TABLE `institute_mendez`.`provider_type` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `code` int(11) NOT NULL,
  `description` varchar(45) NOT NULL,
  `active` bit(1) NOT NULL,
...
CREATE TABLE `institute_mendez`.`delivery_note_enumerator` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE `institute_mendez`.`concept` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `code` int(11) NOT NULL,
  `description` varchar(45) NOT NULL,
...
CREATE TABLE `institute_mendez`.`agreement` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `code` int(11) NOT NULL,
  `description` varchar(45) NOT NULL,
...
CREATE TABLE `institute_mendez`.`concept_event` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE `institute_mendez`.`product` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `code` int(11) NOT NULL,
  `description` varchar(100) NOT NULL,
...
CREATE TABLE `institute_mendez`.`product_gtin` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE `institute_mendez`.`product_price` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE `institute_mendez`.`province` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(45) NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

CREATE TABLE `institute_mendez`.`VAT_liability` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE `institute_mendez`.`provider` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `code` int(11) NOT NULL,
  `name` varchar(45) NOT NULL,
...
CREATE TABLE `institute_mendez`.`client` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `code` int(11) NOT NULL,
  `name` varchar(45) NOT NULL,
  `tax_id` varchar(15) NOT NULL,
...
CREATE TABLE `institute_mendez`.`delivery_location` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `code` int(11) NOT NULL,
  `name` varchar(45) NOT NULL,
  `tax_id` varchar(15) NOT NULL,
...
CREATE TABLE `institute_mendez`.`client_delivery_location` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE `institute_mendez`.`affiliate` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE `institute_mendez`.`logistics_operator` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `code` int(11) NOT NULL,
  `name` varchar(45) NOT NULL,
  `tax_id` varchar(15) NOT NULL,
...
CREATE TABLE `institute_mendez`.`stock` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `product_id` int(11) NOT NULL,
...
CREATE TABLE `institute_mendez`.`input` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `concept_id` int(11) NOT NULL,
  `provider_id` int(11),
...
CREATE TABLE `institute_mendez`.`input_detail` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE `institute_mendez`.`output` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `concept_id` int(11) NOT NULL,
  `provider_id` int(11),
  `delivery_location_id` int(11),
...
CREATE TABLE `institute_mendez`.`output_detail` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE `institute_mendez`.`supplying` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `client_id` int(11) NOT NULL,
...
CREATE TABLE `institute_mendez`.`supplying_detail` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE `institute_mendez`.`provisioning_request_state` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `description` varchar(20) NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

CREATE TABLE `institute_mendez`.`provisioning_request` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `agreement_id` int(11) NOT NULL,
  `client_id` int(11) NOT NULL,
  `delivery_location_id` int(11) NOT NULL,
...
CREATE TABLE `institute_mendez`.`provisioning_request_detail` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE `institute_mendez`.`order` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `provisioning_request_id` int(11) NOT NULL,
  `cancelled` bit(1) NOT NULL,
  PRIMARY KEY (`id`),
...
CREATE TABLE `institute_mendez`.`order_detail` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE `institute_mendez`.`delivery_note` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE `institute_mendez`.`delivery_note_detail` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE `institute_mendez`.`serial_separation_mapping` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE `institute_mendez`.`provider_serialized_format` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE `institute_mendez`.`user` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(45) NOT NULL,
...
CREATE TABLE `institute_mendez`.`role` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `code` varchar(45) NOT NULL,
  `description` varchar(100) NOT NULL,
  PRIMARY KEY (`id`),
...
CREATE TABLE `institute_mendez`.`user_role` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE `institute_mendez`.`property` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `code` int(11) NOT NULL,
  `name` varchar(45) NOT NULL,
  `tax_id` varchar(15) NOT NULL,
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `code_UNIQUE` (`code`),
  KEY `fk_institute_mendez_property_province_idx` (`province_id`),
  KEY `fk_institute_mendez_property_agent_idx` (`agent_id`),
  CONSTRAINT `fk_institute_mendez_property_agent` FOREIGN KEY (`agent_id`) REFERENCES `agent` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `fk_institute_mendez_property_province` FOREIGN KEY (`province_id`) REFERENCES `province` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `fk_institute_mendez_property_start_trace_concept` FOREIGN KEY (`start_trace_concept_id`) REFERENCES `concept` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `fk_institute_mendez_property_supplying_concept` FOREIGN KEY (`supplying_concept_id`) REFERENCES `concept` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
  ) ENGINE=InnoDB DEFAULT CHARSET=utf8;

CREATE TABLE `institute_mendez`.`audit_action` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `description` varchar(45) NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE `institute_mendez`.`audit` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `role_id` int(11)  NOT NULL,
...
CREATE TABLE `institute_mendez`.`agreement_transfer` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE `institute_mendez`.`agreement_transfer_detail` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
