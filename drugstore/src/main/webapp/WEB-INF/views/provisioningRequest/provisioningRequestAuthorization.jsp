...
<script type="text/javascript" src="js/form/provisioningRequest/provisioningRequestAuthorization.js"></script>
...
<div class="row">
	<div class="col-md-9 form-group">
		<h3><spring:message code="provisioningRequest.authorization.label" /></h3>
	</div>
</div>
<div class="row">
